/// scrAnimationIndexSonic()
 // -- Sonic animations
    ...
    switch(animationIndex)
    {
        ...
        // -- Look up reset animation
        case "LOOK_UP_RESET":
            scrAnimationSet(sprSonicLookUpReset, 0, -1, -1, 0.2, 1, 0, -1, "");
        break;
        ...
        // -- Crouch reset animation
        case "CROUCH_RESET":
            scrAnimationSet(sprSonicCrouchReset, 0, -1, -1, 0.33, 1, 0, -1, "");
        break;
        ...
        // -- Land animation
        case "LAND":
            scrAnimationSet(sprSonicLand, 0, -1, 1, 0.28, 1, 1, -1, "");
        break;
