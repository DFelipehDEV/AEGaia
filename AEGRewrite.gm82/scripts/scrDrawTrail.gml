/// @description  scrDrawTrail(length,width,color,sprite,slim,alpha)
// Ex. scrDrawTrail(32,32,c_white,-1,1,1)
var Length,Width,Color,Sprite,Slim,Alpha,AlphaT,Texture,Dir,Dim,Min;
// Preparing variables
...
if (ArrayTrail[0,2] != noone || ArrayTrail[1,2] != noone)
{
    Height = 2;
}
