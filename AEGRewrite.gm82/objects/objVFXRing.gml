...
/// -- Increase scale/size and destroy
    ...
    {
        scrDummyEffectCreate(x + dcos(sparkleAngle)*15, y - dsin(sparkleAngle)*15, choose(sprVFXRingSparkle1, sprVFXRingSparkle2, sprVFXRingSparkle3), 0.5, 0, 1, bm_normal, 1, 1, 1, 0)
    }
#define Draw_0
/*"/*'/**//* YYD ACTION
lib_id=1
